...
@Component({
  selector: 'app-admin-add-commission-management',
  templateUrl: './admin-add-commission-management.component.html',
  styleUrls: ['./admin-add-commission-management.component.scss']
})
export class AdminAddCommissionManagementComponent implements OnInit {
  ...
  cancel() {
    ...
    this.listmode = true;
    this.onPageReload();
    this.router.navigateByUrl('admin/commission-management')
  }
