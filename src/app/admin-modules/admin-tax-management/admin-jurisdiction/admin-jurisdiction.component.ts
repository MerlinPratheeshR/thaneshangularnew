...
@Component({
  selector: 'app-admin-jurisdiction',
  templateUrl: './admin-jurisdiction.component.html',
  styleUrls: ['./admin-jurisdiction.component.scss']
})
export class AdminJurisdictionComponent implements OnInit {
  ...
  addJurisdiction() {
    this.router.navigateByUrl('admin/tax-management/jurisdiction/add/0');
  }
