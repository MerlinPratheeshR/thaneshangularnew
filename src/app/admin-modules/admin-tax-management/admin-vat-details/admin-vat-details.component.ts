...
@Component({
  selector: 'app-admin-vat-details',
  templateUrl: './admin-vat-details.component.html',
  styleUrls: ['./admin-vat-details.component.scss']
})
export class AdminVatDetailsComponent implements OnInit {
  ...
  addvatdetail() {
    this.router.navigateByUrl('admin/tax-management/vat-details/add/0');
  }
