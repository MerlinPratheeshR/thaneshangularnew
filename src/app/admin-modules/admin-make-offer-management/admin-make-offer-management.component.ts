...
@Component({
  selector: 'app-admin-make-offer-management',
  templateUrl: './admin-make-offer-management.component.html',
  styleUrls: ['./admin-make-offer-management.component.scss']
})
export class AdminMakeOfferManagementComponent implements OnInit {
  ...
  addMakeOffer() {
    this.router.navigateByUrl('admin/MakeOffer-management/configure/add/0');
  }
  ...
  editMakeOffer(data) {
    this.router.navigateByUrl('admin/MakeOffer-management/configure/update/' + data.id);
  }
