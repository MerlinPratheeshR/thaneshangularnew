...
@Component({
  selector: 'app-admin-vin-search-history-management',
  templateUrl: './admin-vin-search-history-management.component.html',
  styleUrls: ['./admin-vin-search-history-management.component.scss']
})
export class AdminVinSearchHistoryManagementComponent implements OnInit {
